...
#' @param DT data.table to compute a metric from
#' @param metrics character vector. Vector of metrics to compute
#' @param ci_method One of 'mean', TODO: Fill in the rest determining how the CI/se should be generated
